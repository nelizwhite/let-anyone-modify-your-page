    ...
    def get(self):
    	...
    	template_values = {
    		...
    		'concepts10': [
    			...
    			['lesson-10-5', 'Validation', 'Validating user input is one way to protect web applications from being hacked and improve security; string substitution and HTML escaping.'],
    			['lesson-10-6', 'Templates', 'Templates separate different types of code, allow for more readable and modifiable code, and help to create more secure websites.']
